...
public class TaskBoardService {
    ...
    public Boolean strategyChangeStatus(Long userId, Integer taskId, TaskStatusEnum targetStatus){
        TaskBoardStatus<BaseTaskBoardParam> handler = taskStatusHandlerMap.get(targetStatus);
        //  兜底
        if (ObjectUtils.isEmpty(handler)){
            throw new BusinessException("不支持的操作: " + targetStatus);
        }
